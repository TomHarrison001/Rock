...
private:
    ...
    void createTextureImage()
    {
        ...
        stbi_uc* pixels = stbi_load("./res/textures/vikingRoom.png", &texWidth, &texHeight, &texChannels, STBI_rgb_alpha);
    ...
    void loadModel()
    {
        ...
        if (!tinyobj::LoadObj(&attrib, &shapes, &materials, &warn, &err, "./res/models/vikingRoom.obj"))
